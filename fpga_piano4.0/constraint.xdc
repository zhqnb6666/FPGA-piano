...
# Higher 8 , key_on , loop , player_select_on,song_select_on
...
set_property PACKAGE_PIN R3 [get_ports {player_select_on}]
set_property IOSTANDARD LVCMOS33 [get_ports {player_select_on}]
