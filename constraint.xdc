...
set_property PACKAGE_PIN G2 [get_ports {digit_select_output[0]}]
set_property PACKAGE_PIN C2 [get_ports {digit_select_output[1]}]
set_property PACKAGE_PIN C1 [get_ports {digit_select_output[2]}]
