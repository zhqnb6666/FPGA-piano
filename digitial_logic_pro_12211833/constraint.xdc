...
set_property IOSTANDARD LVCMOS33 [get_ports {mode_input[0]}] 
set_property IOSTANDARD LVCMOS33 [get_ports {mode_input[1]}]  
set_property IOSTANDARD LVCMOS33 [get_ports {mode_input[2]}] 
...
set_property IOSTANDARD LVCMOS33 [get_ports {song_select_led_output}]  
set_property PACKAGE_PIN K6 [get_ports {song_select_led_output}]
